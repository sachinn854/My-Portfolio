    ...
    <section id="home" className="min-h-screen flex items-center relative overflow-hidden bg-gradient-to-br from-gray-900 via-[hsl(var(--dark-bg-primary))] to-[hsl(var(--dark-bg-secondary))]">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="space-y-10">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-6 py-3 glass rounded-full shadow-[0_0_20px_rgba(74,222,128,0.1)] animate-fade-in border border-green-500/20">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse shadow-[0_0_8px_rgba(74,222,128,0.8)]"></div>
            <span className="text-xs font-bold text-green-400 uppercase tracking-widest">Available for opportunities</span>
          </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              ...
              >
                <h1 className="text-5xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                  Hi, I'm{' '}
                  <span className="bg-gradient-to-r from-purple-400 via-purple-300 to-orange-400 bg-clip-text text-transparent underline decoration-purple-500/30 underline-offset-8">
                    Sachin
                  </span>
                </h1>
              </div>
              ...
              <div
                ref={subtitleRef}
                className={`text-3xl lg:text-5xl font-extrabold transition-all duration-1000 delay-300 ${subtitleVisible ? 'animate-text-slide-up' : 'opacity-0'
                  }`}
              >
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-2xl font-light animate-fade-in delay-500">
              Architecting the future with <span className="text-white font-medium">Deep Learning, NLP, and RAG systems</span>.
              Dedicated to building intelligent, scalable AI solutions that solve complex real-world challenges.
            </p>
          </div>
          ...
          <div className="flex items-center space-x-8 pt-6 animate-fade-in delay-200">
            ...
            <div className="flex items-center space-x-6">
              <a href="https://github.com/sachinn854" target="_blank" rel="noopener noreferrer"
                className="w-12 h-12 glass rounded-full flex items-center justify-center text-gray-300 hover:text-purple-400 shadow-lg hover:shadow-purple-500/20 transition-all duration-300 transform hover:scale-110 border border-white/5 hover:border-purple-500/30"
              >
        ...
        <div className="flex justify-center lg:justify-end animate-scale-up delay-500">
          <div className="relative">
            <div className="relative w-96 h-96 lg:w-[450px] lg:h-[450px]">
              {/* Animated rings */}
              <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500 to-orange-500 animate-spin opacity-30 blur-sm" style={{ animation: 'spin 20s linear infinite' }}></div>
              <div className="absolute inset-2 rounded-full bg-gradient-to-r from-orange-500 to-purple-500 animate-spin opacity-40 blur-sm" style={{ animation: 'spin 25s linear infinite reverse' }}></div>
